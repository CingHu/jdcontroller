...
func TestIPv4PackBinary(t *testing.T) {
	b := "   55 " + // Version, IHL
		"00 " + // DSCP, ECN
		"00 14 " + // Length
		"00 00 " + // Id
...
func TestIPv4UnpackBinary(t *testing.T) {
	b := "   55 " + // Version, IHL
		"00 " + // DSCP, ECN
		"00 14 " + // Length
		"00 00 " + // Id
	...
	if int(ip.Len()) != len(byte) {
		...
		t.Errorf("Got protocol %d, expected %d.", ip.Protocol, TCP)
