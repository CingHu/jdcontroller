...
func (s *StatsReply) PackBinary() (data []byte, err error) {
	...
	if s.Body != nil {
		...
		case OFPSTGroupFeatures:
			bs, err = s.Body.(*GroupFeaturesStats).PackBinary()
		case OFPSTExperimenter:
			bs, err = s.Body.(*ExperimenterStatsHeader).PackBinary()
		}
		if err != nil {
			return
		}
...
func (s *StatsReply) UnpackBinary(data []byte) (err error) {
	...
	if n < len(data) {
		...
		case OFPSTGroupFeatures:
			r = s.Body.(*GroupFeaturesStats)
		case OFPSTExperimenter:
			r = s.Body.(*ExperimenterStatsHeader)
		}
		ss := make([]byte, r.Len())
...
func (s *TableStats) PackBinary() (data []byte, err error) {
	...
	binary.Write(buf, binary.BigEndian, s.WriteSetFields)
	binary.Write(buf, binary.BigEndian, s.ApplySetFields)
	binary.Write(buf, binary.BigEndian, s.MetadataMatch)
	binary.Write(buf, binary.BigEndian, s.MetadataWrite)
...
func (s *TableStats) UnpackBinary(data []byte) (err error) {
	...
	binary.Read(buf, binary.BigEndian, &s.WriteSetFields)
	binary.Read(buf, binary.BigEndian, &s.ApplySetFields)
	binary.Read(buf, binary.BigEndian, &s.MetadataMatch)
	binary.Read(buf, binary.BigEndian, &s.MetadataWrite)
...
func NewGroupFeaturesStats() (s *GroupFeaturesStats) {
	s = new(GroupFeaturesStats)
	return
}

func (s *GroupFeaturesStats) Len() (l int) {
	return 40
}

func (s *GroupFeaturesStats) PackBinary() (data []byte, err error) {
	buf := bytes.NewBuffer(make([]byte, 0))
...
func (s *GroupFeaturesStats) UnpackBinary(data []byte) (err error) {
	buf := bytes.NewBuffer(data)
...
func NewExperimenterStatsHeader() (s *ExperimenterStatsHeader) {
	s = new(ExperimenterStatsHeader)
	return
}

func (s *ExperimenterStatsHeader) Len() (l int) {
	return 8
}

func (s *ExperimenterStatsHeader) PackBinary() (data []byte, err error) {
	buf := bytes.NewBuffer(make([]byte, 0))
	binary.Write(buf, binary.BigEndian, s.Experimenter)
	binary.Write(buf, binary.BigEndian, s.ExpType)
	data = buf.Bytes()
	return
}

func (s *ExperimenterStatsHeader) UnpackBinary(data []byte) (err error) {
	buf := bytes.NewBuffer(data)
	binary.Read(buf, binary.BigEndian, &s.Experimenter)
	binary.Read(buf, binary.BigEndian, &s.ExpType)
	return
}
